 ...
 * the purpose of this class is to create a user based off
 * user input of name,email,password,and account type
...
//        transports = new ArrayList<>();
    ...
    /**
     * This method takes the json object and formats it into a string
     * @return
     *  string with retrofit response information
     */
