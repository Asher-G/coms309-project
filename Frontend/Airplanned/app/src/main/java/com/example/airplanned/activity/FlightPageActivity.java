...
/**
 * The purpose of this activity is to search for a real-world flight based on
 * date and depart airport code and arrive airport code. So the user can search
 * for a specific real flight and add it to their trip.
 *
 * @author Julie Duong
 */
public class FlightPageActivity extends AppCompatActivity implements FlightAdapter.RecycleViewClickListener {
    ...
    /**
     * This method searches for a real flight based on
     * @date in form of YYYY-MM-DD
     * @depart airport code. Ex: NYC
     * @arrive airport code. Ex: DSM
     *
     */
    ...
    /**
     * This method is implemented from FlightAdapter class.
     * The purpose is to able to click on specific flight on recycle view and save it to the trip.
     * @param position
     */
    @Override
    public void OnClick(int position) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                flight.setPrice(flights.get(position).getPrice());
